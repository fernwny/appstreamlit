...
list the topic, first verse to ninth but the sixth verse repeat the topic and the vocabulary of the song in a JSON array without index.
...
-tenth line should be the list of dictionary of the song
