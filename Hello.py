...
list the topic, 8 verses and list the vocabulary and the meaning in the song in a JSON array without index.
...
-tenth line should be the vocabulary and the meaning
