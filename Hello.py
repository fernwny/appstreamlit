...
list the topic, first verse to ninth and the vocabulary of the song in a JSON array without index.
...
-tenth line should be the vocabulary of the song with meaning
